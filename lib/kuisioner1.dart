...
import 'package:myapp/setting.dart';
 // Pastikan ini file untuk tambah meditasi

class Kuisioner1Screen extends StatelessWidget {
  const Kuisioner1Screen({super.key});
                    ...
                    child: InkWell(
                      onTap: () {
                        Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => KuisionerScreen()));
                      },
                      child: Padding(
                        padding:
